...
#define ALARM_PATTERNS      (ds1302_sram_data + 0x13) ///< Per-alarm beep patterns[0..4] at 0x13-0x17 (freed by 5-alarm reduction)
#define LANGUAGE            (ds1302_sram_data[0x1a])  ///< Display language: 0=EN, 1=ES
