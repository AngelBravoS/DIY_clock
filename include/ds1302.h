...
#define BR_LEVEL            (ds1302_sram_data[0x19]) ///< Brightness level: 0=auto, 1-10=manual
#define ALARM_PATTERNS      (ds1302_sram_data + 0x13) ///< Per-alarm beep patterns[0..4] at 0x13-0x17
